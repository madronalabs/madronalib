...
static const float kRotaryStartDefault = ml::kPi*-0.75f;
static const float kRotaryEndDefault = ml::kPi*0.5f;
...
{	
	...
	{	
		...
		if ((bool)getFloatProperty("highlight"))
		{
			...
			pg.setColour (hc);
            track.addArc(rx1-mh, ry1-mh, mDiameter+m, mDiameter+m, 0.f, ml::kTwoPi, true);
