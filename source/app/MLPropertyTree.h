...
public:
  ...
  float getFloatPropertyWithDefault(Path p, float d) const { return properties[p].getFloatValueWithDefault(d); }
  bool getBoolPropertyWithDefault(Path p, bool d) const { return properties[p].getBoolValueWithDefault(d); }
  int getIntPropertyWithDefault(Path p, int d) const { return properties[p].getIntValueWithDefault(d); }
  Text getTextPropertyWithDefault(Path p, Text d) const { return properties[p].getTextValueWithDefault(d); }
  Matrix getMatrixPropertyWithDefault(Path p, Matrix d) const { return properties[p].getMatrixValueWithDefault(d); }
