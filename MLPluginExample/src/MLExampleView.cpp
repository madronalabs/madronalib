...
// --------------------------------------------------------------------------------
#pragma mark MLExampleView

MLExampleView::MLExampleView(MLPluginProcessor* const pProcessor, MLPluginController* pC) :
...
{			
	...
	myLookAndFeel->addPicture ("masthead", MLExampleBinaryData::masthead_svg, MLExampleBinaryData::masthead_svgSize);
	myLookAndFeel->addPicture ("arrowleft", MLExampleBinaryData::arrowleft_svg, MLExampleBinaryData::arrowleft_svgSize);
	myLookAndFeel->addPicture ("arrowright", MLExampleBinaryData::arrowright_svg, MLExampleBinaryData::arrowright_svgSize);
...
void MLExampleView::setAttribute(MLSymbol attr, float val)
{
	MLWidget::setAttribute(attr, val);
	// debug() << "MLExampleView " << getWidgetName() << ": setAttribute " << attr << " = " << val << "\n";
	// no attributes of this view to set. 
}

void MLExampleView::setupColors()
{
	MLLookAndFeel* myLookAndFeel = MLLookAndFeel::getInstance();
	...
	myLookAndFeel->setColour(MLLookAndFeel::buttonBackgroundColor, Colour::fromHSV(0.41f, 0.20f, 0.75f, 1.f));	
	...
	myLookAndFeel->setColour(MLLookAndFeel::defaultDialFillColor, Colour::fromHSV(0.41f, 0.34f, 0.75f, 1.f));	// little dials fill
