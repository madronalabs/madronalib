...
// Detect a number of compiler features - mostly C++11/14 conformance - by
// compiler The following features are defined:
//
// CATCH_CONFIG_CPP11_NULLPTR : is nullptr supported?
// CATCH_CONFIG_CPP11_NOEXCEPT : is noexcept supported?
// CATCH_CONFIG_CPP11_GENERATED_METHODS : The delete and default keywords for
// compiler generated methods CATCH_CONFIG_CPP11_IS_ENUM : std::is_enum is
// supported? CATCH_CONFIG_CPP11_TUPLE : std::tuple is supported
...
// configured
#if defined(CATCH_INTERNAL_CONFIG_CPP11_NULLPTR) && \
    !defined(CATCH_CONFIG_CPP11_NO_NULLPTR) &&      \
    !defined(CATCH_CONFIG_CPP11_NULLPTR) && !defined(CATCH_CONFIG_NO_CPP11)
#define CATCH_CONFIG_CPP11_NULLPTR
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_NOEXCEPT) && \
    !defined(CATCH_CONFIG_CPP11_NO_NOEXCEPT) &&      \
    !defined(CATCH_CONFIG_CPP11_NOEXCEPT) && !defined(CATCH_CONFIG_NO_CPP11)
#define CATCH_CONFIG_CPP11_NOEXCEPT
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_GENERATED_METHODS) && \
    !defined(CATCH_CONFIG_CPP11_NO_GENERATED_METHODS) &&      \
    !defined(CATCH_CONFIG_CPP11_GENERATED_METHODS) &&         \
    !defined(CATCH_CONFIG_NO_CPP11)
#define CATCH_CONFIG_CPP11_GENERATED_METHODS
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_IS_ENUM) && \
    !defined(CATCH_CONFIG_CPP11_NO_IS_ENUM) &&      \
    !defined(CATCH_CONFIG_CPP11_IS_ENUM) && !defined(CATCH_CONFIG_NO_CPP11)
#define CATCH_CONFIG_CPP11_IS_ENUM
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_TUPLE) && \
    !defined(CATCH_CONFIG_CPP11_NO_TUPLE) &&      \
    !defined(CATCH_CONFIG_CPP11_TUPLE) && !defined(CATCH_CONFIG_NO_CPP11)
#define CATCH_CONFIG_CPP11_TUPLE
#endif
#if defined(CATCH_INTERNAL_CONFIG_VARIADIC_MACROS) && \
    !defined(CATCH_CONFIG_NO_VARIADIC_MACROS) &&      \
    !defined(CATCH_CONFIG_VARIADIC_MACROS)
...
struct AutoReg
{
  ...
  {
    registerTestCase(new MethodTestCase<C>(method), className, nameAndDesc,
                     lineInfo);
  }
...
#define INTERNAL_CATCH_TESTCASE(...)                                      \
  ...
  Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)(               \
      ...
      CATCH_INTERNAL_LINEINFO, Catch::NameAndDesc(__VA_ARGS__));          \
  }                                                                       \
  static void INTERNAL_CATCH_UNIQUE_NAME(____C_A_T_C_H____T_E_S_T____)()
...
#define INTERNAL_CATCH_METHOD_AS_TEST_CASE(QualifiedMethod, ...)               \
  ...
  {                                                                            \
  Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)(                    \
      &QualifiedMethod, "&" #QualifiedMethod, Catch::NameAndDesc(__VA_ARGS__), \
...
#define INTERNAL_CATCH_TEST_CASE_METHOD(ClassName, ...)                       \
  ...
  Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)(                   \
      ...
      #ClassName, Catch::NameAndDesc(__VA_ARGS__), CATCH_INTERNAL_LINEINFO);  \
  }                                                                           \
...
#define INTERNAL_CATCH_METHOD_AS_TEST_CASE(QualifiedMethod, Name, Desc)       \
  ...
  {                                                                           \
  Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)(                   \
      &QualifiedMethod, "&" #QualifiedMethod, Catch::NameAndDesc(Name, Desc), \
      CATCH_INTERNAL_LINEINFO);                                               \
  }
...
#define INTERNAL_CATCH_TEST_CASE_METHOD(ClassName, TestName, Desc)            \
  ...
  Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)(                   \
      &INTERNAL_CATCH_UNIQUE_NAME(____C_A_T_C_H____T_E_S_T____)::test,        \
      #ClassName, Catch::NameAndDesc(TestName, Desc),                         \
      CATCH_INTERNAL_LINEINFO);                                               \
  }                                                                           \
  void INTERNAL_CATCH_UNIQUE_NAME(____C_A_T_C_H____T_E_S_T____)::test()
...
struct ElementPrinter
{
  ...
  {
    os << (N ? ", " : " ") << Catch::toString(std::get<N>(tuple));
...
#define INTERNAL_CHECK_THAT(arg, matcher, resultDisposition, macroName)       \
  ...
  {                                                                           \
    Catch::ResultBuilder __catchResult(macroName, CATCH_INTERNAL_LINEINFO,    \
                                       #arg " " #matcher, resultDisposition); \
    try                                                                       \
    {                                                                         \
      std::string matcherAsString = ::Catch::Matchers::matcher.toString();    \
      __catchResult.setLhs(Catch::toString(arg))                              \
          .setRhs(matcherAsString == Catch::Detail::unprintableString         \
                      ? #matcher                                              \
                      : matcherAsString)                                      \
          .setOp("matches")                                                   \
...
inline Impl::Generic::AllOf<ExpressionT> AllOf(
    Impl::Matcher<ExpressionT> const& m1, Impl::Matcher<ExpressionT> const& m2)
{
      ...
      for (u_int m = 0; m < count; m++)
      {
        ...
        if (startsWith(methodName, "Catch_TestCase_"))
        {
          ...
          getMutableRegistryHub().registerTest(
              makeTestCase(new OcMethod(cls, selector), className, name.c_str(),
...
#define OC_TEST_CASE(name, desc)                                            \
  +(NSString*)INTERNAL_CATCH_UNIQUE_NAME(Catch_Name_test) { return @name; } \
...
class Config : public SharedImpl<IConfig>
{
 ...
 public:
  Config() : m_os(Catch::cout().rdbuf()) {}

  Config(ConfigData const& data) : m_data(data), m_os(Catch::cout().rdbuf())
  {
...
inline TrackedSection* TrackedSection::acquireChild(
...
struct FatalConditionHandler
{
  static void handleSignal(int sig)
  {
    for (std::size_t i = 0; i < sizeof(signalDefs) / sizeof(SignalDefs); ++i)
      if (sig == signalDefs[i].id) fatal(signalDefs[i].name, -sig);
...
class Runner
{
 public:
  ...
  Totals runTests()
  {
    ...
    getRegistryHub().getTestCaseRegistry().getFilteredTests(testSpec, *m_config,
                                                            testCases);
    ...
    getRegistryHub().getTestCaseRegistry().getFilteredTests(
        testSpec, *m_config, skippedTestCases, true);

    for (std::vector<TestCase>::const_iterator it = skippedTestCases.begin(),
                                               itEnd = skippedTestCases.end();
         it != itEnd; ++it)
 ...
 public:
  ...
  virtual void registerTest(TestCase const& testCase)
  {
    ...
    else
    {
      ...
      {
        Colour colourGuard(Colour::Red);
        Catch::cerr() << "error: TEST_CASE( \"" << name
                      << "\" ) already defined.\n"
                      << "\tFirst seen at " << prev.getTestCaseInfo().lineInfo
                      << "\n"
                      << "\tRedefined at "
                      << testCase.getTestCaseInfo().lineInfo << std::endl;
      }
      exit(1);
    }
  }
                                ...
                                bool negated = false) const
  {
    ...
    {
      bool includeTest =
          testSpec.matches(*it) && (config.allowThrows() || !it->throws());
      if (includeTest != negated) matchingTestCases.push_back(*it);
    }
    sortTests(config, matchingTestCases);
  }

 private:
  static void sortTests(IConfig const& config,
                        std::vector<TestCase>& matchingTestCases)
  {
    switch (config.runOrder())
    {
      case RunTests::InLexicographicalOrder:
        std::sort(matchingTestCases.begin(), matchingTestCases.end(),
                  LexSort());
        break;
...
#ifndef CATCH_CONFIG_NOSTDOUT  // If you #define this you must implement this
                               // functions
...
{
  static IColourImpl* impl =
      isDebuggerActive() ? NoColourImpl::instance() : platformColourInstance();
                                  ...
                                  SourceLineInfo const& _lineInfo)
{
  if (isReservedTag(tag))
  {
    {
      Colour colourGuard(Colour::Red);
      Catch::cerr() << "Tag name [" << tag << "] not allowed.\n"
                    << "Tag names starting with non alpha-numeric characters "
                       "are reserved\n";
    }
    {
...
TestCase makeTestCase(ITestCase* _testCase, std::string const& _className,
                      std::string const& _name, std::string const& _descOrTags,
                      SourceLineInfo const& _lineInfo)
{
...
std::string toString(const wchar_t* const value)
{
  return value ? Catch::toString(std::wstring(value))
               : std::string("{null string}");
}
...
std::string toString(int value)
{
  std::ostringstream oss;
  oss << value;
  if (value >= 255) oss << " (0x" << std::hex << value << ")";
  return oss.str();
}
  ...
  virtual void sectionStarting(SectionInfo const& sectionInfo)
  {
    ...
    else
    {
      ...
      SectionNode::ChildSections::const_iterator it = std::find_if(
          parentNode.childSections.begin(), parentNode.childSections.end(),
...
class XmlWriter
{
 public:
  ...
  XmlWriter() : m_tagIsOpen(false), m_needsNewline(false), m_os(&Catch::cout())
  {
  }
...
class XmlReporter : public StreamingReporterBase
{
 public:
  XmlReporter(ReporterConfig const& _config)
      : StreamingReporterBase(_config), m_sectionDepth(0)
  {
  }
  ...
  virtual bool assertionEnded(AssertionStats const& assertionStats)
  {
    ...
    if (assertionStats.assertionResult.getResultType() != ResultWas::Ok)
    {
           ...
           it != itEnd; ++it)
      {
        ...
        {
          m_xml.scopedElement("Warning").writeText(it->message);
        }
      }
    }
...
#define CATCH_SCENARIO_METHOD(className, name, tags) \
...
#define WARN(msg)                               \
  INTERNAL_CATCH_MSG(Catch::ResultWas::Warning, \
                     Catch::ResultDisposition::ContinueOnFailure, "WARN", msg)
