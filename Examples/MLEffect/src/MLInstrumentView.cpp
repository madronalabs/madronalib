...
// --------------------------------------------------------------------------------
#pragma mark MLInstrumentView

MLInstrumentView::MLInstrumentView(MLPluginProcessor* const pProcessor, MLPluginController* pC) :
...
{			
	...
	myLookAndFeel->addPicture ("masthead", MLInstrumentBinaryData::masthead_svg, MLInstrumentBinaryData::masthead_svgSize);
	myLookAndFeel->addPicture ("arrowleft", MLInstrumentBinaryData::arrowleft_svg, MLInstrumentBinaryData::arrowleft_svgSize);
	myLookAndFeel->addPicture ("arrowright", MLInstrumentBinaryData::arrowright_svg, MLInstrumentBinaryData::arrowright_svgSize);
...
MLInstrumentView::~MLInstrumentView()
{
...
void MLInstrumentView::setAttribute(MLSymbol attr, float val)
{
	MLWidget::setAttribute(attr, val);
	// debug() << "MLInstrumentView " << getWidgetName() << ": setAttribute " << attr << " = " << val << "\n";
	// no attributes of this view to set. 
}

void MLInstrumentView::setupColors()
{
	MLLookAndFeel* myLookAndFeel = MLLookAndFeel::getInstance();
