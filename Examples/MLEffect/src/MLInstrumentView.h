...
public:
    ...
    MLInstrumentView(MLPluginProcessor* const pProcessor, MLPluginController* pC);
    ~MLInstrumentView();
...
private:
    ...
    MLInstrumentView (const MLInstrumentView&);
    const MLInstrumentView& operator= (const MLInstrumentView&);
