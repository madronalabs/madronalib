...
// superseded by ML defines in XCode project. 
// formats to build are now defined by picking a target in XCode.

#define JucePlugin_Build_VST ML_BUILD_VST
...
*/
#define JucePlugin_Name                     "MLInstrumentExample"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "MadronaLib instrument example"

/** The name of your company. (Try to keep this as short as possible)
*/
#define JucePlugin_Manufacturer             "Madrona Labs"

/** A four-character code for your company.
    Use single quotes - this isn't a string!
*/
#define JucePlugin_ManufacturerCode         'MLbs'
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'MLex'
...
/** This allows the plugin to specify the configurations of input/output channels that
    ...
    methods.
*/
#define JucePlugin_PreferredChannelConfigurations   { 0, 2 }, { 0, 4 }
...
#define JucePlugin_MaxFramesPerSlice	8192

//==============================================================================
/** A version number
*/

#define JucePlugin_VersionCode              0x00000900
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           MLInstrumentExample

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "MLInstrumentExample"
...
*/
#define JucePlugin_CFBundleIdentifier       "com.madronalabs.mlinstrument"

#define JucePlugin_AUCocoaViewClassName		MLInstrument_v0_9
