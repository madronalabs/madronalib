...
*/
#define JucePlugin_Name                     "MLDemoInstrument"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "MadronaLib instrument demo"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'MLin'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           MLDemoInstrument

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "MLDemoInstrument"
...
*/
#define JucePlugin_CFBundleIdentifier       "com.madronalabs.mldemoinstrument"

#define JucePlugin_AUCocoaViewClassName		MLDemoInstrument_1_0
